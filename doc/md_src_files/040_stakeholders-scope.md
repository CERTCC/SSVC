...
For example, an organization may have a development team may take on the supplier stakeholder role for the software it produces and an internal IT team that takes on a deployer stakeholder role for, as an example, managing the email clients its employees use. 
