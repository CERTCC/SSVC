...
For now, assume the decision points are ordered as: [*Exploitation*](#exploitation); [*Exposure*](#exposure); [*Utility*](#utility); and [*Well-being and Mission Impact*](#situated-safety---mission-impact).
