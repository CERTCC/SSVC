...
[*System Exposure*](#system-exposure) could be informed by the various scanning platforms such as and Shodan and Shadowserver.
...
There are some information sources that were not designed with SSVC in mind, but can be adapted to work.
