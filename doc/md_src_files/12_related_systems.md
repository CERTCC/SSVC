...
The EPSS [update](https://arxiv.org/abs/2304.14172.pdf) is focused on designing a scoring system which includes practitioner requirements and achieving performance improvements on the observable state of the world at the time of the SSVC decision.
