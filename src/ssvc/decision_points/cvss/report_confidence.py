...
CONFIRMED_2 = SsvcDecisionPointValue(
    name="Confirmed",
    key="C",
...
REASONABLE = SsvcDecisionPointValue(
    name="Reasonable",
    key="R",
...
CONFIRMED = SsvcDecisionPointValue(
    name="Confirmed",
    key="C",
...
UNCORROBORATED = SsvcDecisionPointValue(
    name="Uncorroborated",
    key="UR",
...
UNCONFIRMED = SsvcDecisionPointValue(
    name="Unconfirmed",
    key="UC",
...
values = list(REPORT_CONFIDENCE_1_1.values)
values.append(NOT_DEFINED)
REPORT_CONFIDENCE_1_1.values = tuple(values)
