...
# Isolated
#
# Operates in a narrow, stable context with no meaningful external awareness.
...
# Connected
#
# Uses curated signals, scoped identity roles, or predefined multi-agent patterns to adapt.
# Environmental changes can influence behavior, but only within controlled, auditable bounds.
#
# Pervasive
#
# Continuously adapts to broad, dynamic environmental inputs and multi-agent activity.
