...
# Safety Impact16F
# 16 Type of Harm Description
# None All Does not mean no impact literally; it just means that the effect is below the threshold for all aspects
# described in Minor
# Minor
# (Any one or
# more of these
...
# Operator
# resiliency
# Requires action by system operator to maintain safe system state as a result of exploitation of the
# vulnerability where operator actions would be well within expected operator abilities; OR causes a
# minor occupational safety hazard
# System
# resiliency
...
# resiliency
# Requires action by system operator to maintain safe system state as a result of exploitation of the
# vulnerability where operator actions would be within their capabilities but the actions require their full
# attention and effort; OR significant distraction or discomfort to operators; OR causes significant occupational safety hazard
# System
# resiliency
...
# Psychological Widespread emotional or psychological harm, sufficient to be cause for counselling or therapy, to
...
# conditions
# hold.)
# Physical harm Serious or fatal injuries, where fatalities are plausibly preventable via emergency services or other
# measures
# Operator
# resiliency
# Actions that would keep the system in a safe state are beyond system operator capabilities, resulting
# in adverse conditions; OR great physical distress to system operators such that they cannot be expected to operate the system properly
# System
# resiliency
...
# Financial Socio-technical system (elections, financial grid, etc.) of which the affected component is a part is
# actively destabilized and enters unsafe state
# Psychological N/A
# Catastrophic
# (Any one or
# more of these
